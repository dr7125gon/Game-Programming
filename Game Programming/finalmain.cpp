...
void FyMain(int argc, char **argv)
{
	...
	player = new Player(controller, pos, fDir, uDir, 15.0f, 10.0f, 50, 250);
	...
	pos[0] -= 150.0f;
	enemyArray[0] = new enemy(-1, player->getID(), "Donzo2", pos, fDir, uDir, 15.0f, 5.0f, 135.0f, 70, 45, 0);
